...
void MapBlock::updateFastFaces()
{
	...
	irr::core::list<FastFace*> *fastfaces_new = new irr::core::list<FastFace*>;
	...
	*/
	...
	irr::core::list<FastFace*> *fastfaces_old = fastfaces;
	...
	*/
	...
	irr::core::list<FastFace*>::Iterator i = fastfaces_old->begin();
