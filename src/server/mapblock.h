...
public:
    ...
    irr::core::list<FastFace*> *fastfaces;
		...
		: m_parent(parent), m_pos(pos), changed(true)
	{
		data = NULL;
		reallocate();
		fastfaces = new irr::core::list<FastFace*>;
	...
	~MapBlock()
	{
		...
		irr::core::list<FastFace*>::Iterator i = fastfaces->begin();
	...
	irr::core::aabbox3d<s16> getBox()
	{
		return irr::core::aabbox3d<s16>(getPosRelative(),
