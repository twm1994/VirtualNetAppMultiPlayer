//
// Generated file, do not edit! Created by nedtool 5.5 from messages/Connect.msg.
//
...
unsigned short Connect::getPeerId() const
{
    return this->peerId;
}

void Connect::setPeerId(unsigned short peerId)
{
    this->peerId = peerId;
}
...
std::string ConnectDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return ulong2string(pp->getPeerId());
        default: return "";
    }
}
...
bool ConnectDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setPeerId(string2ulong(value)); return true;
