...
Gossip::Gossip(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->sendTime = 0;
    this->lastRound = 0;
}

Gossip::Gossip(const Gossip& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void Gossip::copy(const Gossip& other)
{
    ...
    this->lastRound = other.lastRound;
}
...
void Gossip::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->lastRound);
}
...
void Gossip::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->lastRound);
}
...
::omnetpp::simtime_t Gossip::getSendTime() const
{
    return this->sendTime;
}

void Gossip::setSendTime(::omnetpp::simtime_t sendTime)
{
...
GossipDescriptor::GossipDescriptor() : omnetpp::cClassDescriptor("Gossip", "omnetpp::cPacket")
{
...
int GossipDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *GossipDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string GossipDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool GossipDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *GossipDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
