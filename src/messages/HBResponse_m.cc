...
HBResponse::HBResponse(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->displayString = DISPLAY_STR_MSG_HIDDEN;
    this->timestamp = 0;
}

HBResponse::HBResponse(const HBResponse& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void HBResponse::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void HBResponse::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
::omnetpp::simtime_t HBResponse::getTimestamp() const
{
    return this->timestamp;
}

void HBResponse::setTimestamp(::omnetpp::simtime_t timestamp)
{
    this->timestamp = timestamp;
}

class HBResponseDescriptor : public omnetpp::cClassDescriptor
{
  private:
...
HBResponseDescriptor::HBResponseDescriptor() : omnetpp::cClassDescriptor("HBResponse", "omnetpp::cPacket")
{
...
bool HBResponseDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<HBResponse *>(obj)!=nullptr;
}

const char **HBResponseDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *HBResponseDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *HBResponseDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int HBResponseDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *HBResponseDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string HBResponseDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool HBResponseDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *HBResponseDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *HBResponseDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
