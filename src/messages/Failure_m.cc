...
Failure::Failure(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
}

Failure::Failure(const Failure& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void Failure::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->hostAddress);
}

void Failure::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cPacket::parsimUnpack(b);
    doParsimUnpacking(b,this->hostAddress);
}

const char * Failure::getHostAddress() const
{
    return this->hostAddress.c_str();
}
...
FailureDescriptor::FailureDescriptor() : omnetpp::cClassDescriptor("Failure", "omnetpp::cPacket")
{
