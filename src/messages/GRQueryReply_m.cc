//
// Generated file, do not edit! Created by nedtool 5.5 from messages/GRQueryReply.msg.
//
...
GRQueryReply::GRQueryReply(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
...
GRQueryReply::GRQueryReply(const GRQueryReply& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void GRQueryReply::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void GRQueryReply::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
class GRQueryReplyDescriptor : public omnetpp::cClassDescriptor
{
  private:
...
GRQueryReplyDescriptor::GRQueryReplyDescriptor() : omnetpp::cClassDescriptor("GRQueryReply", "omnetpp::cPacket")
{
...
bool GRQueryReplyDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<GRQueryReply *>(obj)!=nullptr;
}

const char **GRQueryReplyDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
int GRQueryReplyDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 5+basedesc->getFieldCount() : 5;
}

unsigned int GRQueryReplyDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *GRQueryReplyDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int GRQueryReplyDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *GRQueryReplyDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **GRQueryReplyDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *GRQueryReplyDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int GRQueryReplyDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *GRQueryReplyDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string GRQueryReplyDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 4: return oppstring2string(pp->getState());
        default: return "";
    }
}

bool GRQueryReplyDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 4: pp->setState((value)); return true;
        default: return false;
    }
}

const char *GRQueryReplyDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *GRQueryReplyDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
