//
// Generated file, do not edit! Created by nedtool 5.4 from messages/HandShake.msg.
//
...
HandShake::HandShake(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
    this->senderId = 0;
    this->seq = 0;
    this->joinTime = 0;
...
HandShake::HandShake(const HandShake& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
unsigned long HandShake::getSenderId() const
{
    return this->senderId;
}

void HandShake::setSenderId(unsigned long senderId)
{
    this->senderId = senderId;
}

int HandShake::getSeq() const
{
    return this->seq;
}

void HandShake::setSeq(int seq)
{
    this->seq = seq;
}

const char * HandShake::getSourceName() const
{
    return this->sourceName.c_str();
}

void HandShake::setSourceName(const char * sourceName)
{
    this->sourceName = sourceName;
}

const char * HandShake::getDestName() const
{
    return this->destName.c_str();
}

void HandShake::setDestName(const char * destName)
{
    this->destName = destName;
}

::omnetpp::simtime_t HandShake::getJoinTime() const
{
    return this->joinTime;
}

void HandShake::setJoinTime(::omnetpp::simtime_t joinTime)
{
    this->joinTime = joinTime;
}

const char * HandShake::getLCName() const
{
    return this->LCName.c_str();
}

void HandShake::setLCName(const char * LCName)
{
    this->LCName = LCName;
}
...
HandShakeDescriptor::HandShakeDescriptor() : omnetpp::cClassDescriptor("HandShake", "omnetpp::cPacket")
{
...
const char *HandShakeDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
