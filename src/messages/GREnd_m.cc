...
GREnd::GREnd(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
...
GREnd::GREnd(const GREnd& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void GREnd::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void GREnd::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
const char * GREnd::getQc() const
{
    return this->Qc.c_str();
}

void GREnd::setQc(const char * Qc)
{
    this->Qc = Qc;
}

const char * GREnd::getInit() const
{
    return this->init.c_str();
}

void GREnd::setInit(const char * init)
{
    this->init = init;
}

class GREndDescriptor : public omnetpp::cClassDescriptor
{
  private:
...
GREndDescriptor::GREndDescriptor() : omnetpp::cClassDescriptor("GREnd", "omnetpp::cPacket")
{
...
bool GREndDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<GREnd *>(obj)!=nullptr;
}

const char **GREndDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
int GREndDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 8+basedesc->getFieldCount() : 8;
}

unsigned int GREndDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *GREndDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int GREndDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    ...
    if (fieldName[0]=='Q' && strcmp(fieldName, "Qc")==0) return base+6;
    if (fieldName[0]=='i' && strcmp(fieldName, "init")==0) return base+7;
    return basedesc ? basedesc->findField(fieldName) : -1;
}

const char *GREndDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char **GREndDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *GREndDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int GREndDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *GREndDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string GREndDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 6: return oppstring2string(pp->getQc());
        case 7: return oppstring2string(pp->getInit());
        default: return "";
    }
}

bool GREndDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 6: pp->setQc((value)); return true;
        case 7: pp->setInit((value)); return true;
        default: return false;
    }
}

const char *GREndDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *GREndDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
